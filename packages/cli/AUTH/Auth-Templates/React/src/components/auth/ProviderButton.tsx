...
const icons = {
  ...
  microsoft: (
    <svg className="mr-2 h-4 w-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="windows" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
export function ProviderButton({ provider, onClick, isLoading }: { provider: 'google' | 'github' | 'microsoft', onClick?: () => void, isLoading?: boolean }) {
  return (
    <button
      type="button"
      onClick={onClick}
